...
from fpl_forecast.constants import DEFAULT_BUDGET, FIXTURE_TICKER_GWS, MAX_PER_CLUB
...
def build_forecast(
    ...
    scores = score_all_players(players, bootstrap["teams"], gw_fixtures, element_summaries, set_piece_notes)
    ...
    return result, gw, scores, ticker
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        result, gw, scores, ticker = build_forecast(
    ...
    if args.html:
        write_html(result, gw, args.html, all_scores=scores, fixture_ticker=ticker)
