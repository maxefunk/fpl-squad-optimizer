...
def render_html(result: SquadResult, gameweek: int) -> str:
    rows_html = []
...
<div class="wrap">
  ...
  <footer>Generated by fpl-squad-optimizer &middot; not affiliated with the Premier League or Fantasy Premier League</footer>
</div>
</body>
</html>
"""
...
def write_html(result: SquadResult, gameweek: int, path: str) -> None:
    html = render_html(result, gameweek)
